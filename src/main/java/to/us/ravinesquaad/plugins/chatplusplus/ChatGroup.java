...
//        if (!super.equals(o)) return false;
    ...
    public void addMember(String adder, String player) {
        add(player);
        refreshHoverableText();
        ProfileMap.getProfile(player).groups.add(this);
...
//        ProfileMap.getProfile(player).groups.remove(this);
        ...
        if(ChatPlusPlus.debug) System.out.println("Groups removed from player, ending group list: " + Arrays.toString(ProfileMap.getProfile(player).groups.toArray()));
        sendSpigotMessage(player, addedMessage);
    }
